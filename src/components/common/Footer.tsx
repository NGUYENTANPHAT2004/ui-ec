        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link to="/account" className="hover:text-red-500 transition-colors">My Account</Link></li>
              <li><Link to="/login" className="hover:text-red-500 transition-colors">Login / Register</Link></li>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/terms" className="hover:text-red-500 transition-colors">Terms Of Use</Link></li>
